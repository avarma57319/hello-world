...
person_df1 <- read.csv("C:/Users/arjun/Documents/DSC520/DATA/person.csv")
str(person_df1)
...
person_df2 <- read.csv("C:/Users/arjun/Documents/DSC520/DATA/person.csv", stringsAsFactors=FALSE)
person_df2


# Read the file `data/scores.csv` to `scores_df`
# Display summary statistics using the `summary()` function
scores_df <- read.csv("C:/Users/arjun/Documents/DSC520/DATA/scores.csv")
summary(scores_df)

# Load the `readxl` library
# Library-package was missing in Rstudio installation so first had to install CELLRANGER and then READXL
# READXL obtained from: 'https://cran.rstudio.com/bin/windows/contrib/4.1/readxl_1.3.1.zip'
# READXL installed to: C:/Users/arjun/Documents/R/win-library/4.1
# CELLRANGER obtained from: 'https://cran.rstudio.com/bin/windows/contrib/4.1/cellranger_1.1.0.zip'
# CELLRANGER installed to: C:/Users/arjun/Documents/R/win-library/4.1
library(readxl)
...
excel_sheets("C:/Users/arjun/Documents/DSC520/DATA/G04ResultsDetail2004-11-02.xls")
...
voter_turnout_df1 <- read_excel("C:/Users/arjun/Documents/DSC520/DATA/G04ResultsDetail2004-11-02.xls", sheet = "Voter Turnout", skip = 1)
...
voter_turnout_df2 <- read_excel("C:/Users/arjun/Documents/DSC520/DATA/G04ResultsDetail2004-11-02.xls", sheet = "Voter Turnout",
                                col_names = c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout"), skip = 2)
str(voter_turnout_df2)

# Load the `DBI` library
# Library-package was missing in Rstudio installation so first had to manually install
# DBI package obtained from: 'https://cran.rstudio.com/bin/windows/contrib/4.1/DBI_1.1.1.zip'
# DBI Package installed to: C:/Users/arjun/Documents/R/win-library/4.1
library(DBI)
...
# Number of packages were missing and gave error when trying the connection
# Manually installed the following packages before making a successful connection: fastmap, cachem, memoise, blob, bit, bit64, RSQLite
db <- dbConnect(RSQLite::SQLite(), "C:/Users/arjun/Documents/DSC520/DATA/example.db")
...
# Package jsonlite was missing and had to install it manually
# jsonlite installed from: 'https://cran.rstudio.com/bin/windows/contrib/4.1/jsonlite_1.7.2.zip'
# Package installed to: C:/Users/arjun/Documents/R/win-library/4.1
library(jsonlite)
